(define 
  ...
  (:init 
   ...
   (zerox-rel xrel0) 
   (zeroy-rel yrel0) 
   (thing-goal thing0 x3 y6)
   (thing-goal thing0 x4 y3)
   (thing-goal thing1 x3 y7)
   (thing-goal thing1 x8 y5)
   (thing-goal thing2 x4 y6)
   (thing-goal thing3 x4 y7)
   ...
   (base-obstacle x7 y5)(surface x7 y5)
   ...
   (thing-pos thing0 x7 y3)
   (thing-pos thing1 x3 y6)
   (thing-pos thing2 x9 y8)
