(define 
  ...
  (:init 
   ...
   (thing-goal thing0 x8 y7)
   (thing-goal thing1 x7 y4)
   (thing-goal thing1 x8 y9)
   (thing-goal thing2 x8 y3)
   (thing-goal thing2 x8 y7)
   (thing-goal thing3 x8 y4)
   (thing-goal thing3 x7 y7)
   (thing-goal thing4 x2 y5)
   (thing-goal thing4 x6 y8)
   (thing-goal thing5 x2 y6)
   (thing-goal thing5 x6 y7)
   (thing-goal thing6 x3 y5)
   (thing-goal thing7 x3 y6)
   (thing-goal thing7 x8 y9)
   
   (parked pr2)
   (not-pushing pr2)
   (base-pos pr2 x0 y0)
   (base-obstacle x0 y0)
   (base-obstacle x6 y7)(surface x6 y7)
   ...
   (thing-pos thing0 x2 y5)
   (thing-pos thing1 x8 y7)
   (thing-pos thing2 x8 y8)
   (thing-pos thing3 x8 y4)
   (thing-pos thing4 x6 y9)
   (thing-pos thing5 x6 y7)
   (thing-pos thing6 x7 y4)
   (thing-pos thing7 x2 y6)
