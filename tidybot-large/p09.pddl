(define 
  ...
  (:init 
   ...
   (zerox-rel xrel0) 
   (zeroy-rel yrel0) 
   (thing-goal thing0 x2 y7)
   (thing-goal thing1 x2 y8)
   (thing-goal thing2 x3 y7)
   (thing-goal thing3 x3 y8)
   (thing-goal thing4 x2 y2)
   (thing-goal thing4 x7 y1)
   (thing-goal thing5 x2 y3)
   (thing-goal thing5 x7 y3)
   (thing-goal thing6 x3 y2)
   (thing-goal thing7 x3 y3)
   (thing-goal thing7 x7 y1)
   (thing-goal thing8 x7 y6)
   (thing-goal thing8 x9 y3)
   (thing-goal thing9 x7 y7)
   (thing-goal thing9 x7 y3)
   (thing-goal thing10 x8 y6)
   (thing-goal thing10 x8 y1)
   (thing-goal thing11 x8 y7)
   
   (parked pr2)
   (not-pushing pr2)
   (base-pos pr2 x0 y0)
   (base-obstacle x0 y0)
   (base-obstacle x7 y1)(surface x7 y1)
   (base-obstacle x7 y2)(surface x7 y2)
   ...
   (base-obstacle x6 y7)(gripper-obstacle x6 y7)
   (base-obstacle x6 y8)(gripper-obstacle x6 y8)
