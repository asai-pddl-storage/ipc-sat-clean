(define 
  ...
  (:init 
   ...
   (zerox-rel xrel0) 
   (zeroy-rel yrel0) 
   (thing-goal thing0 x3 y2)
   (thing-goal thing1 x3 y3)
   (thing-goal thing1 x1 y10)
   (thing-goal thing2 x4 y2)
   (thing-goal thing3 x4 y3)
   (thing-goal thing4 x8 y2)
   (thing-goal thing4 x1 y10)
   (thing-goal thing5 x8 y3)
   (thing-goal thing6 x9 y2)
   (thing-goal thing6 x3 y10)
   (thing-goal thing7 x9 y3)
   (thing-goal thing8 x6 y7)
   (thing-goal thing9 x6 y8)
   (thing-goal thing10 x7 y7)
   (thing-goal thing11 x7 y8)
   
   (parked pr2)
   (not-pushing pr2)
   (base-pos pr2 x0 y0)
   (base-obstacle x0 y0)
   (base-obstacle x1 y6)(surface x1 y6)
   ...
   (base-obstacle x2 y6)(surface x2 y6)
   ...
   (base-obstacle x3 y6)(surface x3 y6)
   ...
   (base-obstacle x7 y1)(gripper-obstacle x7 y1)
   ...
   (base-obstacle x9 y1)(gripper-obstacle x9 y1)
   (base-obstacle x9 y4)(gripper-obstacle x9 y4)
   (base-obstacle x10 y1)(gripper-obstacle x10 y1)
   (base-obstacle x10 y2)(gripper-obstacle x10 y2)
   (base-obstacle x10 y3)(gripper-obstacle x10 y3)
   (base-obstacle x10 y4)(gripper-obstacle x10 y4)
   (base-obstacle x5 y6)(gripper-obstacle x5 y6)
   ...
   (thing-pos thing0 x4 y2)
   (thing-pos thing1 x1 y9)
   (thing-pos thing2 x1 y6)
   (thing-pos thing3 x9 y3)
   (thing-pos thing4 x1 y10)
   (thing-pos thing5 x1 y8)
   (thing-pos thing6 x2 y10)
   (thing-pos thing7 x6 y7)
   (thing-pos thing8 x9 y2)
   (thing-pos thing9 x7 y7)
   (thing-pos thing10 x3 y6)
   (thing-pos thing11 x6 y8)
   
   (gripper-empty pr2)
   (gripper-rel pr2 xrel0 yrel0)
   (gripper-obstacle x4 y2)
   (gripper-obstacle x1 y9)
   (gripper-obstacle x1 y6)
   (gripper-obstacle x9 y3)
   (gripper-obstacle x1 y10)
   (gripper-obstacle x1 y8)
   (gripper-obstacle x2 y10)
   (gripper-obstacle x6 y7)
   (gripper-obstacle x9 y2)
   (gripper-obstacle x7 y7)
   (gripper-obstacle x3 y6)
   (gripper-obstacle x6 y8)
  ) 
