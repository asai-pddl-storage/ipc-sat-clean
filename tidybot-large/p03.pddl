(define 
  ...
  (:init 
   ...
   (zerox-rel xrel0) 
   (zeroy-rel yrel0) 
   (thing-goal thing0 x6 y5)
   (thing-goal thing0 x2 y1)
   (thing-goal thing1 x6 y6)
   (thing-goal thing2 x7 y5)
   (thing-goal thing2 x1 y1)
   (thing-goal thing3 x7 y6)
   ...
   (thing-pos thing0 x1 y7)
   (thing-pos thing1 x6 y6)
   (thing-pos thing2 x6 y5)
   (thing-pos thing3 x1 y6)
