(define 
  ...
  (:init 
   ...
   (zerox-rel xrel0) 
   (zeroy-rel yrel0) 
   (thing-goal thing0 x6 y4)
   (thing-goal thing0 x3 y3)
   (thing-goal thing1 x6 y5)
   (thing-goal thing1 x2 y2)
   (thing-goal thing2 x7 y4)
   (thing-goal thing2 x1 y5)
   (thing-goal thing3 x7 y5)
   (thing-goal thing3 x3 y5)
   ...
   (base-obstacle x2 y4)(surface x2 y4)
   ...
   (thing-pos thing0 x3 y6)
   (thing-pos thing1 x1 y5)
   (thing-pos thing2 x7 y5)
   (thing-pos thing3 x3 y2)
   
   (gripper-empty pr2)
   (gripper-rel pr2 xrel0 yrel0)
   (gripper-obstacle x3 y6)
   (gripper-obstacle x1 y5)
