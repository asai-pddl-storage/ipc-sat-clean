(define 
  ...
  (:init 
   ...
   (thing-pos thing0 x7 y1)
   (thing-pos thing1 x7 y3)
   (thing-pos thing2 x2 y3)
   (thing-pos thing3 x7 y6)
   (thing-pos thing4 x2 y8)
   (thing-pos thing5 x8 y7)
   (thing-pos thing6 x8 y2)
   (thing-pos thing7 x8 y6)
   (thing-pos thing8 x7 y7)
   (thing-pos thing9 x3 y7)
   (thing-pos thing10 x3 y8)
   (thing-pos thing11 x6 y2)
