(define 
  ...
  (:init 
   ...
   (zerox-rel xrel0) 
   (zeroy-rel yrel0) 
   (thing-goal thing0 x2 y2)
   (thing-goal thing1 x2 y3)
   (thing-goal thing2 x3 y2)
   (thing-goal thing3 x3 y3)
   (thing-goal thing3 x3 y6)
   (thing-goal thing4 x7 y2)
   (thing-goal thing5 x7 y3)
   (thing-goal thing5 x3 y8)
   (thing-goal thing6 x8 y2)
   (thing-goal thing7 x8 y3)
   (thing-goal thing7 x1 y8)
   (thing-goal thing8 x6 y7)
   (thing-goal thing9 x6 y8)
   (thing-goal thing10 x7 y7)
   (thing-goal thing10 x1 y6)
   ...
   (base-obstacle x9 y2)(gripper-obstacle x9 y2)
   ...
   (base-obstacle x8 y8)(gripper-obstacle x8 y8)
   ...
   (thing-pos thing0 x3 y2)
   (thing-pos thing1 x2 y2)
   (thing-pos thing2 x7 y8)
   (thing-pos thing3 x7 y2)
   (thing-pos thing4 x6 y7)
   (thing-pos thing5 x8 y2)
   (thing-pos thing6 x2 y3)
   (thing-pos thing7 x3 y3)
   (thing-pos thing8 x2 y8)
   (thing-pos thing9 x3 y8)
   (thing-pos thing10 x1 y8)
   (thing-pos thing11 x2 y6)
