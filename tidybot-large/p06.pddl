(define 
  ...
  (:init 
   ...
   (thing-goal thing2 x9 y4)
   (thing-goal thing3 x4 y3)
   (thing-goal thing4 x5 y7)
   (thing-goal thing4 x8 y4)
   (thing-goal thing5 x5 y8)
   (thing-goal thing5 x9 y2)
   (thing-goal thing6 x6 y7)
   (thing-goal thing6 x9 y2)
   (thing-goal thing7 x6 y8)
   ...
   (thing-pos thing0 x9 y3)
   (thing-pos thing1 x7 y2)
   (thing-pos thing2 x3 y2)
   (thing-pos thing3 x6 y8)
   (thing-pos thing4 x4 y3)
   (thing-pos thing5 x9 y4)
   (thing-pos thing6 x8 y4)
   (thing-pos thing7 x7 y3)
