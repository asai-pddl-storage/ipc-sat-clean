(define 
  ...
  (:init 
   ...
   (thing-goal thing1 x4 y4)
   (thing-goal thing2 x5 y3)
   (thing-goal thing3 x5 y4)
   ...
   (base-obstacle x5 y7)(surface x5 y7)
   ...
   (thing-pos thing1 x7 y7)
   (thing-pos thing2 x6 y7)
   (thing-pos thing3 x5 y9)
