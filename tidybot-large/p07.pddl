(define 
  ...
  (:init 
   ...
   (zerox-rel xrel0) 
   (zeroy-rel yrel0) 
   (thing-goal thing0 x2 y4)
   (thing-goal thing0 x7 y9)
   (thing-goal thing1 x2 y5)
   (thing-goal thing1 x7 y7)
   (thing-goal thing2 x3 y4)
   (thing-goal thing3 x3 y5)
   (thing-goal thing3 x8 y9)
   (thing-goal thing4 x7 y3)
   (thing-goal thing4 x9 y8)
   (thing-goal thing5 x7 y4)
   (thing-goal thing5 x8 y9)
   (thing-goal thing6 x8 y3)
   (thing-goal thing6 x7 y7)
   (thing-goal thing7 x8 y4)
   ...
   (thing-pos thing1 x2 y4)
   (thing-pos thing2 x7 y7)
   (thing-pos thing3 x2 y5)
   (thing-pos thing4 x7 y8)
   (thing-pos thing5 x9 y8)
   (thing-pos thing6 x7 y4)
   (thing-pos thing7 x8 y3)
