(define 
  ...
  (:init 
   ...
   (zerox-rel xrel0) 
   (zeroy-rel yrel0) 
   (thing-goal thing0 x5 y7)
   (thing-goal thing1 x5 y8)
   (thing-goal thing2 x6 y7)
   (thing-goal thing3 x6 y8)
   (thing-goal thing3 x9 y2)
   (thing-goal thing4 x3 y2)
   (thing-goal thing4 x7 y1)
   (thing-goal thing5 x3 y3)
   (thing-goal thing6 x4 y2)
   (thing-goal thing6 x9 y3)
   (thing-goal thing7 x4 y3)
   (thing-goal thing7 x8 y1)
   ...
   (thing-pos thing0 x6 y7)
   (thing-pos thing1 x8 y1)
   (thing-pos thing2 x9 y2)
   (thing-pos thing3 x6 y8)
   (thing-pos thing4 x7 y4)
   (thing-pos thing5 x3 y3)
   (thing-pos thing6 x9 y3)
   (thing-pos thing7 x7 y2)
