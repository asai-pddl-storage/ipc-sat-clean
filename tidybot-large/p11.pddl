(define 
  ...
  (:init 
   ...
   (thing-goal thing0 x7 y3)
   (thing-goal thing1 x4 y7)
   (thing-goal thing1 x2 y1)
   (thing-goal thing2 x5 y6)
   (thing-goal thing2 x8 y1)
   ...
   (base-obstacle x5 y3)(surface x5 y3)
   ...
   (thing-pos thing0 x5 y1)
   (thing-pos thing1 x9 y1)
   (thing-pos thing2 x5 y3)
   (thing-pos thing3 x1 y1)
